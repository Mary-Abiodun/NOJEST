...
<!--      session code end -->
    <form action="uploadsubmissionfiles.php" method="post" enctype="multipart/form-data">
                ...
                <span><button type="submit" class="btn btn-success" name="submit" value="">Save And Continue</button><a type="button "class="btn btn-outline-success ml-2" name="Cancel">Cancel</a><a type="button" href="confirmation.php" class="btn btn-success ml-2" name="Next">Next</a></span>
            </form>
        </div>
